...
password = os.getenv('POSTGRES_PASSWORD', 'emprestimo')
host = os.getenv('POSTGRES_HOST', 'emprestimo_db')
port = os.getenv('POSTGRES_PORT', 'emprestimo_db')
db = os.getenv('POSTGRES_DB', 'emprestimo')
